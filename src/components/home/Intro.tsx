...
export default function Intro() {
  return (
    <div className="flex flex-col md:flex-row items-center w-full h-full p-4 md:p-8 text-[#4B3F37]">
      ...
      <div className="relative w-full md:w-2/5 mx-auto rounded-lg overflow-hidden border">
        <Image
          ...
          className="z-0"
        />
        <p className="relative z-10 text-center text-[#4B3F37] text-xl p-12 md:p-16 bg-opacity-70 bg-[#D7CCC8]">
